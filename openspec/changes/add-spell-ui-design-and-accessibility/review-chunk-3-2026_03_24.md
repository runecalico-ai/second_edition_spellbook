...
**[H-001] (72) — Loading indicator flickers on fresh spell-detail navigation**
...
**[H-002] (65) — Dark-only classes on SpellEditor print controls and Cancel button in edited surfaces**
...
**[H-003] (62) — "Reset Filters" briefly shows a false empty-library state when the library is not empty**
...
**[H-004] (58) — EmptyState live regions are freshly mounted; AT may not announce them reliably**
...
**[M-001] (48) — Hash copy button has no accessible description of what it copies**
...
**[M-002] (42) — Missing test: hash card rendered for a spell loaded without contentHash**
...
**[M-003] (38) — SpellbookBuilder spell-count label shows 0 during spellbook load**
...
**[M-004] (36) — SpellbookBuilder sr-only live region omits the "No Spells Added" heading**
...
**[M-005] (34) — EmptyState re-mount on rapid filter cycling may cause duplicate AT announcements**
...
**[M-006] (32) — Missing test: Reset Filters regression guard for non-empty library**
