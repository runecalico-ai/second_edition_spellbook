...
- **[`wt list --full`](https://worktrunk.dev/list/#full-mode)** — [CI status](https://worktrunk.dev/list/#ci-status) and [AI-generated summaries](https://worktrunk.dev/list/#llm-summaries-experimental) per branch
- **[PR checkout](https://worktrunk.dev/switch/#github-pull-requests)** — `wt switch pr:123` to jump straight to a PR's branch
