---
name: "source-command-ses-format-codebase"
description: "Format the codebase using Biome (Frontend), Rustfmt (Backend), and Ruff (Python)"
---

# source-command-ses-format-codebase

Use this skill when the user asks to run the migrated source command `ses-format-codebase`.
