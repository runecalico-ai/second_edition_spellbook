        ...
        <div className="border border-amber-800/50 rounded-lg bg-amber-950/20 p-5 space-y-4">
            ...
            <div className="space-y-2">
                ...
                >
                    ...
                    <span className="ml-2 text-xs text-neutral-500">— keep all existing spells unchanged</span>
                </button>
                ...
                >
                    ...
                    <span className="ml-2 text-xs text-blue-200">— overwrite existing with incoming versions</span>
                </button>
