...
import type { HashImportConflict, HashConflictResolution } from "../../types/import-types";
  ...
  return (
    <div className="border border-neutral-800 rounded-lg bg-neutral-900/50 p-4 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm font-semibold text-neutral-200">{conflict.existingName}</div>
        <span
