              ...
              <div key={entry.spell_id} className='border border-neutral-800 rounded-md p-3 space-y-2'>
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <div className='text-xs text-neutral-500'>{entry.school ?? 'Unknown'} • Level {entry.level}</div>
                  </div>
                ...
                <div className='flex flex-wrap gap-4 text-sm'>
                  <label className='flex items-center gap-2'>
                    <input type='checkbox' checked={entry.prepared} onChange={(e) => handleToggle(entry, 'prepared', e.target.checked)} />
                    Prepared
                  </label>
                  <label className='flex items-center gap-2'>
                    <input type='checkbox' checked={entry.known} onChange={(e) => handleToggle(entry, 'known', e.target.checked)} />
                    Known
                  </label>
                </div>
                <textarea
