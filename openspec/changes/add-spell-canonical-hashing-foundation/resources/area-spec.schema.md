...
# AD&D 2nd Edition – Normalized AreaSpec Enum & Parameter Schema

This document defines a **canonical, normalized AreaSpec** suitable for spell schemas,
validators, and resolved spell snapshots. It mirrors `RangeSpec` and `DurationSpec`.
...
Same scalar model used by RangeSpec and DurationSpec:
