...
The project core architecture utilizes a Tauri-based desktop wrapper with a Rust backend and a React frontend. Data is stored in a local SQLite database with extensions for search and vector operations.
