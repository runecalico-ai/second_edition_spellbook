    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="flex flex-col gap-1">
        <input
          ...
          type="text"
          aria-label={label}
          className="w-full bg-white dark:bg-neutral-900 border border-neutral-500 dark:border-neutral-700 text-neutral-900 dark:text-neutral-100 p-2 rounded text-sm"
          value={value}
      ...
      {expanded && (
        <section
          ...
          className="mt-2 p-3 rounded border border-neutral-500 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-900/80"
        >
          {children}
        </section>
      )}
