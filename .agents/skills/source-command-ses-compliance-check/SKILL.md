---
name: "source-command-ses-compliance-check"
description: "Perform a compliance check on UI Best practices for a component or page"
---

# source-command-ses-compliance-check

Use this skill when the user asks to run the migrated source command `ses-compliance-check`.
