...
- [x] **Step 1: Write the failing bootstrap expectation down in the plan branch notes**
...
- [x] **Step 3: Add the pre-hydration theme bootstrap script**
...
- [x] **Step 4: Remove hardcoded dark-only body classes**
...
- [x] **Step 1: Write failing unit tests for theme state**
...
- [x] **Step 1: Write failing router/runtime tests**
...
- [x] **Step 2: Run the router/runtime test to confirm failure**
...
- [x] **Step 3: Add a small root runtime component in `main.tsx`**
...
- [x] **Step 4: Keep routing in the same file and add `/settings`**
...
- [x] **Step 2: Run the component test to confirm failure**
...
- [x] **Step 2: Implement the shell changes**
...
- [x] **Step 3: Re-run the shell test**
...
- [x] **Step 4: Mount the viewport in `App.tsx`**

Render it beside the existing `<Modal />`, not inside page-specific screens.

- [x] **Step 5: Re-run the viewport test**
...
- [x] **Step 1: Extend shell tests with theme announcement expectations**
...
- [x] **Step 2: Implement the hidden live region**
...
- [x] **Step 2: Run the new E2E spec to confirm failure**
...
- [x] **Step 3: Implement any missing selectors or page-object helpers**
...
- [x] **Step 4: Re-run the targeted E2E spec**
...
- [x] **Step 1: Run unit tests for touched files**
...
- [x] **Step 1a: Run router/runtime unit tests**
...
- [x] **Step 4: Run targeted Playwright**
