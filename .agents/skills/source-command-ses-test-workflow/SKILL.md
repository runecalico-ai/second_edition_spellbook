---
name: "source-command-ses-test-workflow"
description: "How to run tests for Backend (Rust), Python Services, and Frontend E2E (Playwright)"
---

# source-command-ses-test-workflow

Use this skill when the user asks to run the migrated source command `ses-test-workflow`.
