---
name: "source-command-ses-lint-codebase"
description: "Lint the entire codebase (Frontend, Backend, Python)"
---

# source-command-ses-lint-codebase

Use this skill when the user asks to run the migrated source command `ses-lint-codebase`.
