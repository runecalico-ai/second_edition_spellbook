...
- [x] **Step 1: Inspect the existing save entry points**
...
- [x] **Step 2: Write a failing unit test for keyboard submit parity**
...
- [x] **Step 3: Run the focused unit test and confirm it fails**
...
- [x] **Step 4: Implement a single submit path in `SpellEditor.tsx`**
...
- [x] **Step 5: Extend unit coverage for invalid and pending states**
...
- [x] **Step 6: Run the spell editor unit tests**
...
- [x] **Step 1: Inspect the current helper-text rendering**
...
- [x] **Step 4: Implement the descriptive relationship**
...
- [x] **Step 5: Verify no regression when `damageKind === "modeled"`**
...
- [x] **Step 6: Run the Magic Resistance component tests**
...
- [x] **Step 1: Locate modal assertions coupled to dialog internals**
...
- [x] **Step 2: Rewrite the modal-focus tests around public contract selectors**
...
- [x] **Step 3: Keep one focused assertion for behavior, not implementation**
...
- [x] **Step 4: Run the accessibility spec and confirm modal tests still pass**
...
- [x] **Step 1: Identify the densest structured surfaces already reachable in the editor**
...
- [x] **Step 2: Add a helper in the Playwright spec to detect nested horizontal clipping**
...
- [x] **Step 3: Upgrade the existing 900px editor tests**
...
- [x] **Step 4: Keep the minimum-width contract explicit**
...
- [x] **Step 5: Run the resize-only coverage**
...
- [x] **Step 1: Find a stable dismissible modal path reachable in tests**
...
- [x] **Step 2: Add keyboard-submit E2E coverage**
...
- [x] **Step 3: Add Escape dismissal coverage using the best reachable layer**
...
- [x] **Step 4: Run the focused test suites**
...
- [x] **Step 2: Spot-check for accidental contract drift**
...
- [x] **Step 3: Update the review report status manually if your workflow requires it**
